...
int main() {
    ...
    // Load the dataset
    Matrix mat = read_csv("./test_datasets/test_linear_simple/regression.csv");
    ...
    // plt::named_plot("Predicted Age", Ji.get_col(0), Ji.get_col(1), "k");
    plt::named_plot("Age", X.get_col(0), Y.get_col(0), "ro");
    plt::named_plot("Predicted Age", X.get_col(0), Y_pred.get_col(0), "k");
