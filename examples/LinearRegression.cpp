...
int main() {
    ...
    plt::save("./build/plots/LinearRegression - Gradient Descent.png");
    plt::show();
    ...
    LinearRegression regr_gdn(true);
    ...
    plt::title("Linear Regression - Gradient Descent with Normalization");
    plt::save("./build/plots/LinearRegression - Gradient Descent with Normalization.png");
    plt::show();
    ...
    LinearRegression regr_ols(false, true);
    ...
    plt::save("./build/plots/LinearRegression - Ordinary Least Squares.png");
    plt::show();
